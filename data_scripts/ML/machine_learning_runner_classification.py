...
if __name__ == "__main__":
    ...
    with performance_report(filename=f"../../tasks/05/dask_ml_report_{args.data_format}_{args.ml_method}.html"):
        ...
        daily_ddf["High Number of Tickets"] = (daily_ddf["count"] > 20000).astype(int)
    ...
    print(f"Dask ML Accuracy: {accuracy_score(y_test_, preds):.6f}")
    print(f"Dask ML Log Loss: {log_loss(y_test_, preds):.6f}")
