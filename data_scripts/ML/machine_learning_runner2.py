...
if __name__ == "__main__":
    ...
    print("Reading Data")
    args = parse_args()
    with performance_report(filename=f"../../tasks/05/dask_ml_report_2_{args.data_format}_{args.ml_method}.html"):
        ...
        X, y = data.drop(columns=["Distance to CHS"]), data["Distance to CHS"]
