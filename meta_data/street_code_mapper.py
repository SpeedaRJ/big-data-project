...
pd.DataFrame(street_mappings).to_csv(
    os.path.join(os.path.dirname(os.path.realpath(__file__)), "street_code_mapper.csv")
)
print("Street code mapper created")
print(f"Successfully parsed {len(street_mappings)} street codes out of {len(lines)}")
